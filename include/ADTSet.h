...
// Επιστρέφει τo στοιχείο στη θέση pos, αν δεν υπάρχει η θέση pos το αποτέλεσμα είναι μη ορισμένο

Pointer set_get_at(Set set, int pos);

// Αλλάζει την τιμή στη θέση pos του Set set σε value.
// ΔΕΝ μεταβάλλει το μέγεθος του set, αν pos < 0 ή pos >= size το αποτέλεσμα δεν είναι ορισμένο.
